    ...
    return (
     <ScrollView>
         <View style={Styles.container}>
             ...
             <View>
                 <View style={{flexDirection:'row',marginTop:'5%',width:WIDTH/1.1}}>
                 ...
                 <View>
                  <TouchableOpacity  style={{flexDirection:'row',width:WIDTH/1.1,marginTop:'5%'}}>
                      <View style={{width:'50%',flexDirection:'row',marginLeft:'8%'}}>
                          <View>
                              <Image style={Styles.proimg} source={require('../assets/icon/vivek.png')}/>
                          </View>
                 ...
                 <View style={{flexDirection:'row',width:WIDTH/1.1,marginTop:'5%'}}>
                     <View style={{width:'50%',flexDirection:'row',marginLeft:'8%'}}>
                         <View>
                             <Image style={Styles.proimg} source={require('../assets/icon/Zean.png')}/>
                         </View>
                         <View style={{marginLeft:'5%'}}>
                 ...
                 <View style={{flexDirection:'row',width:WIDTH/1.1,marginTop:'5%'}}>
                     <View style={{width:'50%',flexDirection:'row',marginLeft:'8%'}}>
                         <View>
                             <Image style={Styles.proimg} source={require('../assets/icon/sampath.png')}/>
                         </View>
                         <View style={{marginLeft:'5%'}}>
                             <Text style={Styles.text1}>Sampath  </Text>
                 ...
                 <View style={{flexDirection:'row',width:WIDTH/1.1,marginTop:'5%'}}>
                     <View style={{width:'50%',flexDirection:'row',marginLeft:'8%'}}>
                         <View>
                             <Image style={Styles.proimg} source={require('../assets/icon/lica.png')}/>
                         </View>
                         <View style={{marginLeft:'5%'}}>
                 ...
                 <View style={{flexDirection:'row',width:WIDTH/1.1,marginTop:'5%'}}>
                     <View style={{width:'50%',flexDirection:'row',marginLeft:'8%'}}>
                         <View>
                             <Image style={Styles.proimg} source={require('../assets/icon/ronen.png')}/>
                         </View>
                         <View style={{marginLeft:'5%'}}>
                             <Text style={Styles.text1}>Zean Ronen</Text>
